...
1. Scrum
2. Read-Host
3. Fichero leer y sumar
4. IEX
5. App Inventor. Formularios. Figma. Vercel. IDX
6. Entornos visuales
7. IntelliJ
8. Explicar desarrollo minube
9. Automatizar. PowerShell. Hacer click. Qué es automatizar? Proceso fabricación. Uipath. RPA. DLL. Hacer click. Sendkeys. Buscar jesusninoc y hacer click. Hacerlo en Kotlin
10. Automatizar Kotlin
11. Formulario + botón + caja de texto
12. JavaFX
13. Presentar formulario automatizado
14. Pruebas
15. Github. 
